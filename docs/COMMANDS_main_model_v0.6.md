...
## 41. v0.6 stopping rule

At this point, do not retrain the model again for this finding.
...
v0.6 repeated stability result
```

Optional next diagnostic only:

```text
v0.7 = repeated calibration-selected aggregation + threshold calibration
```

Do not treat v0.7 as required before writing the v0.6 method/result section.
